...
The parity measurement should report `even' parity when the number of data qubits pointing up and pointing down is even. And it should report `odd' when the number of data qubits pointing up and pointing down is odd.
