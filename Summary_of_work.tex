...
\begin{figure}[H]
	\centering
	\subfloat[]{
		\includegraphics[width=0.49\linewidth]{abrupt_find_tau/abrupt_find_tau_full.pdf}
		\label{fig:abrupt_tau}}
	\subfloat[]{
		\includegraphics[width=0.49\linewidth]{circular_find_tau/circle_find_tau.pdf}
		\label{fig:circ_tau}}
	\label{fig:find_tau}
